...
$string['numberdecoding'] = 'Number decoding';
$string['numberdecodingflexible'] = 'Number decoding allowing various combinations of decsep and thousandssep';
$string['numberdecodingstrict'] = 'Number decoding using the chosen language decsep, thousandssep';
