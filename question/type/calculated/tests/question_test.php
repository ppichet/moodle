...
class qtype_calculated_question_test extends advanced_testcase {
    ...
    public function test_get_correct_response() {
        ...
        $values = $question->vs->get_values();
        $this->assertSame(array('answer' => '3.01' ),
        ...
        $this->assertSame(array('answer' => '3.0' ),
                $question->get_correct_response());
        ...
        $question->start_attempt(new question_attempt_step(), 1);
        $values = $question->vs->get_values();
        $this->assertSame(array('answer' => '6.00' ),
                $question->get_correct_response());
        ...
        $values = $question->vs->get_values();
        $this->assertSame(array('answer' => '31.01' ),
                $question->get_correct_response());
        ...
        $this->assertSame(array('answer' => '31.0' ),
                $question->get_correct_response());
